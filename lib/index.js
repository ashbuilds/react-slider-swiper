...
var ReactIdSwiper = function (_React$Component) {
  ...
  _createClass(ReactIdSwiper, [{
    ...
    value: function componentDidMount() {
      ...
      this.swiper = this.SwiperMain(_reactDom2.default.findDOMNode(this), (0, _objectAssign2.default)({}, this.props));
    }
  }, {
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.props.rebuildOnUpdate && typeof this.swiper !== 'undefined') {
        ...
        this.swiper = this.SwiperMain(_reactDom2.default.findDOMNode(this), (0, _objectAssign2.default)({}, nextProps));
      }
    }
  }, {
